          ...
          }}>
            {
              (quibs ? quibs : []).map((quib) =>
                <QuibTab onClick={() => selectQuibTabOfQuib(quib)}
                  ...
                  <div style={{marginRight: "8px", marginLeft: "8px", fontWeight: "bold",
                    fontSize: "var(--jp-code-font-size)"}}>{quib.name}</div>
                </QuibTab>
              )
            }
          ...
          <div style={{display: "flex", flexWrap: "wrap"}}>
            {
              ...
              selectedQuibNames.map(name => {
                ...
                return quib && <div style={{marginTop: "10px", marginRight: "10px"}}>
