...
@dataclass
class ElementWiseSingleArgFuncDefinition(FuncDefinition):
    """
...
@dataclass
class ElementWiseDualArgFuncDefinition(FuncDefinition):
    """
    Represents a definition of functions that act element-wise on a two args
    """

    inverse_funcs: Optional[Dict[int, Callable]] = None
