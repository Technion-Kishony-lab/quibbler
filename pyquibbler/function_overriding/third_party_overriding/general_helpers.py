...
def override_with_cls(override_cls, module_or_cls,
             ...
             forwards_path_translators: List = None, backwards_path_translators: List = None, inverters: List = None,
             quib_function_call_cls=None, is_file_loading_func=False, replace_previous_quibs_on_artists: bool = False):
    return override_cls(
        func_name=func_name,
