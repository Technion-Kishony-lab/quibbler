...
from pyquibbler.quib.function_running.function_runners.vectorize.vectorize_function_runner \
...
class VectorizeCallDefinition(FunctionDefinition):
    ...
    def get_data_source_argument_values(self, args_values: ArgsValues):
        ...
        """
        from pyquibbler.quib.function_running.function_runners.vectorize.utils import iter_arg_ids_and_values
