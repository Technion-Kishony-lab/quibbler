...
FUNC_DEFINITION_BINARY_ELEMENTWISE_AND_LIST = create_or_reuse_func_definition(
    ...
    [ListOperatorBackwardsPathTranslator] + FUNC_DEFINITION_BINARY_ELEMENTWISE.backwards_path_translators,
    forwards_path_translators=
    [ListOperatorForwardsPathTranslator] + FUNC_DEFINITION_BINARY_ELEMENTWISE.forwards_path_translators,
