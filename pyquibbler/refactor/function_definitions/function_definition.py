...
from typing import Optional, Set, Dict, Any, Type, List, Callable, Union
...
def create_function_definition(data_source_arguments: List[Union[str, int]] = None, inverters: List[Type[Inverter]] = None,
