...
from pyquibbler.quib.function_running.function_runners.vectorize.utils import iter_arg_ids_and_values, get_core_axes
...
if TYPE_CHECKING:
    from pyquibbler.quib.function_running.function_runners.vectorize.vectorize_metadata import ArgId
