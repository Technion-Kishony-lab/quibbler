...
from pyquibbler.quib.graphics.vectorize.vectorize_metadata import VectorizeMetadata
from pyquibbler.quib.graphics.vectorize.utils import copy_vectorize
