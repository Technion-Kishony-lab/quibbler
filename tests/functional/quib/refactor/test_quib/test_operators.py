...
from pyquibbler.overriding.operator_definitions import ARITHMETIC_OPERATORS_DEFINITIONS, UNARY_OPERATORS_DEFINITIONS
...
@pytest.mark.parametrize('operator_name', [override.func_name for override in UNARY_OPERATORS_DEFINITIONS])
