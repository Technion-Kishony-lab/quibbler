...
def test_invalidate_and_redraw_invalidates_that_which_should_be_invalidated(rot90_quib, getitem_quib):
    rot90_quib.handler.invalidate_and_redraw_at_path(PathBuilder(rot90_quib)[0, 0].path)
...
def test_invalidate_and_redraw_does_not_invalidate_that_which_should_not_be_invalidated(rot90_quib, getitem_quib):
    rot90_quib.handler.invalidate_and_redraw_at_path(PathBuilder(rot90_quib)[1, 0].path)
...
def test_invalidate_and_redraw_invalidates_that_which_should_be_invalidated_with_multiple_steps(
    ...
    input_quib.handler.invalidate_and_redraw_at_path(PathBuilder(input_quib)[0, 1].path)
...
def test_invalidate_and_redraw_does_not_invalidate_that_which_should_be_invalidated_with_multiple_steps(
    ...
    input_quib.handler.invalidate_and_redraw_at_path(PathBuilder(input_quib)[0, 2].path)
...
def test_invalidate_and_redraw_on_dict_invalidates_child():
    ...
    quib.handler.invalidate_and_redraw_at_path(PathBuilder(quib)['maor'].path)
...
def test_invalidate_and_redraw_on_dict_doesnt_invalidate_irrelevant_child():
    ...
    quib.handler.invalidate_and_redraw_at_path(PathBuilder(quib)['y'].path)
...
def test_invalidate_and_redraw_on_inner_list():
    ...
    quib.handler.invalidate_and_redraw_at_path(PathBuilder(quib)['a'].path)
...
def test_invalidate_and_redraw_on_dict_after_index():
    ...
    quib.handler.invalidate_and_redraw_at_path(PathBuilder(quib)[2].path)
...
def test_invalidate_embedded_dicts_shouldnt_invalidate(quib_dict):
    ...
    quib_dict.handler.invalidate_and_redraw_at_path(PathBuilder(quib_dict)['a']['c'].path)
...
def test_invalidate_embedded_dicts_should_invalidate(quib_dict):
    ...
    quib_dict.handler.invalidate_and_redraw_at_path(PathBuilder(quib_dict)['a']['b'].path)
...
def test_invalidate_and_redraw_with_expanding_shape_shouldnt_invalidate(quib_with_nested_arr, children):
    ...
    quib_with_nested_arr.handler.invalidate_and_redraw_at_path(PathBuilder(quib_with_nested_arr)[0].path)
...
def test_invalidate_and_redraw_with_double_field_keys_invalidates(quib_with_nested_arr, children):
    ...
    quib_with_nested_arr.handler.invalidate_and_redraw_at_path(PathBuilder(quib_with_nested_arr)["nested"]["child_name"].path)
...
def test_invalidate_and_redraw_multiple_getitems():
    ...
    quib.handler.invalidate_and_redraw_at_path(PathBuilder(quib)[3].path)
...
def test_invalidate_and_redraw_with_dict_and_ndarrays_within():
    ...
    quib.handler.invalidate_and_redraw_at_path(PathBuilder(quib)['a'][0]['c'].path)
...
def test_invalidate_and_redraw_with_dict_and_ndarrays_within_does_not_invalidate():
    ...
    quib.handler.invalidate_and_redraw_at_path(PathBuilder(quib)['a'][0]['e'].path)
...
def test_invalidate_and_redraw_invalidates_all_when_minor_parameter_changes():
    ...
    param.handler.invalidate_and_redraw_at_path(PathBuilder(param)[...].path)
