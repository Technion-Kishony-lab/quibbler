...
def test_drag_right_click_and_undo(create_axes_mouse_press_move_release_events, axes, live_artists):
...
def test_drag_xy_undo(axes, create_axes_mouse_press_move_release_events, live_artists):
