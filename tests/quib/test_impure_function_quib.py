...
from pyquibbler.quib import ImpureFunctionQuib, InvalidCacheBehaviorForImpureFunctionQuibException


@fixture
def impure_function_quib():
    return ImpureFunctionQuib.create(Mock())
...
def test_cant_set_impure_function_cache_behavior_to_something_other_than_on(impure_function_quib, cache_behavior):
    with raises(InvalidCacheBehaviorForImpureFunctionQuibException):
